...
static esp_err_t jpeg_get_handler(httpd_req_t *req)
{
	camera_fb_t * fb = NULL;
	...
	ESP_LOGI(TAG, "JPEG: %lu KB %lu ms", (uint32_t)(fb_len / 1024), (uint32_t)((fr_end - fr_start) / 1000));
